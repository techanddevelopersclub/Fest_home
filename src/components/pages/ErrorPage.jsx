        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <div className="event-info mb-5">
              <h3 className="text-3xl font-bold mb-2">October 13, 2025</h3>
              <h4 className="text-2xl font-semibold">Cieszyc</h4>
              <h4 className="text-xl font-medium">Caravan of the Wonders</h4>
            </div>
            <Link
              to="/"
