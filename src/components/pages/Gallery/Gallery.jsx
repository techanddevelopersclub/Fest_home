...
const Gallery = () => {
  ...
  const galleryImages = [
    {
      id: 1,
      url: "/images/cultural_night_perfromance.jpeg",
      category: "events",
    ...
    {
      id: 7,
      url: "/images/cultural_performance.JPG",
      category: "competitions",
    ...
    {
      id: 8,
      url: "/images/final_of_event.jpeg",
      category: "events",
    ...
    {
      id: 9,
      url: "/images/hardware_hackathon.JPG",
      category: "campus",
    ...
    {
      id: 10,
      url: "/images/award_cerimony_on_stage.jpeg",
      category: "events",
    ...
    <div className="min-h-screen py-16 px-4 md:px-8">
              ...
              <div className="relative aspect-square">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <h3 className="text-white font-display font-black text-xl mb-2 drop-shadow-lg">
                      {image.title}
                    </h3>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/80 to-transparent p-8">
                ...
                <div className="flex items-center gap-6 text-white">
                  ...
                  <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                    ...
                    <span className="capitalize font-body font-light">
      ...
      {filteredImages.length === 0 && (
        <div className="text-center py-32">
          <Camera
            size={80}
            className="mx-auto text-pink-400 mb-6 animate-pulse"
          />
          <p className="text-white text-2xl font-display font-bold">
            No images found in this category
          </p>
          <p className="text-white/60 text-lg mt-2 font-body font-light">
